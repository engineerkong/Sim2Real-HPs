...
if __name__ == '__main__':
    """
    The main function to train a policy on the robogym environment BlockRearrangeEnv based 
    on the sac algorithm and MultiInputPolicy in stable-baselines3.
    """
    ...
    model.learn(total_timesteps=10000, log_interval=10) # /off_policy_algorithm/_dump_logs

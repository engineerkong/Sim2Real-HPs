...
from sb3_py2.preprocessing import get_flattened_obs_dim, is_image_space
from sb3_py2.utils import get_device
...
class NatureCNN(BaseFeaturesExtractor):
    ...
    def __init__(self, observation_space, features_dim = 512):
        ...
        assert is_image_space(observation_space, check_channels=False), ("warning")

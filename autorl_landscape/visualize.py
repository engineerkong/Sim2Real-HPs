...
def visualize_cherry_picks(
    ...
    def make_figure(match_titles: List[str], name: str, x0: str, x1: str, projection = None) -> None:
...
def viz_single_x0x1y(
    ...
    for viz in [v for v in model.get_viz_infos() if v.title in match_titles]:
        ...
        elif viz.viz_type == "map" or viz.viz_type == "contour":
